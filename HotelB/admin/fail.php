...
//include './auth.php';
//mysqli_query($dbhandle, "DELETE FROM `unleashe_hotel`.`booking` WHERE `booking`.`booking_id` = ".$_SESSION['booking_id'].";");
//}
...
<body class="fontbody" style="background-image : url(img/background.jpg); no-repeat center center fixed; background-size: cover;">
	<div class="row ">
		<div class="large-4 columns blackblur " style="margin-top:100px; ">
			...
			<hr> Dear <?php echo $_SESSION['firstname']; ?>, <br>You cancel your deposit. Your payment status is pending.</p>
			<br>
